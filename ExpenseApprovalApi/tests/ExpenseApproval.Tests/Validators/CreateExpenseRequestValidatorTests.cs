...
public class CreateExpenseRequestValidatorTests
{
    ...
    {
        var dto = new CreateExpenseRequestDto(Guid.NewGuid(), "Vuelo", 500m, DateTime.UtcNow.AddDays(-1));
    ...
    {
        var dto = new CreateExpenseRequestDto(Guid.NewGuid(), "", 100m, DateTime.UtcNow.AddDays(-1));
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    }
    ...
    {
        var dto = new CreateExpenseRequestDto(Guid.NewGuid(), "Alimentacion", 0m, DateTime.UtcNow.AddDays(-1));
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    }
    ...
    {
        var dto = new CreateExpenseRequestDto(Guid.NewGuid(), "Alimentacion", -5m, DateTime.UtcNow.AddDays(-1));
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    }
    ...
    {
        var dto = new CreateExpenseRequestDto(Guid.NewGuid(), "Vuelo", 500m, DateTime.UtcNow.AddDays(30));
        var result = await _validator.ValidateAsync(dto);
        result.IsValid.Should().BeFalse();
    }
}
